...
AUTH_CHANNELS = [-1003314249493]  # Add more channel IDs here
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/Oye_brijesh") ],
                    [
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/babu` - Download and upload files (sudo)🎬\n\n"
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[𝐌𝐑 𝐁𝐑𝐈𝐉𝐄𝐒𝐇 😇](https://t.me/Oye_brijesh)"
    if raw_text3 == '1':
        CR = '[𝐌𝐑 𝐁𝐑𝐈𝐉𝐄𝐒𝐇 😇](https://t.me/Oye_brijesh)'
    elif raw_text3:
        try:
    ...
    await m.reply_text(f"<pre><code>『😏ETNA MEHNAT MAT KARO SIR 😄』</code></pre>")                 
